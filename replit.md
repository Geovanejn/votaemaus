...
- **Daily Verse System**: Automated daily Bible verse publishing with AI-generated reflections (5-prompt rotation: pastor, theologian, narrative, exegetical, practical — rotated by day-of-year mod 5), contextual AI-selected background images (Gemini analyzes verse context → generates Unsplash search query → fetches relevant image → uploads to R2, with stock image fallback), deduplication via `imageSourceUrl` tracking (last 60 posts), public page, social media sharing, and push notifications.
