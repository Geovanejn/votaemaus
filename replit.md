...
- **Treasury Module**: Manages member fees (Percapta, UMP), an e-commerce store, and event fee collection. Features financial dashboards and Mercado Pago PIX integration. Includes role-based access for Treasurer and Marketing.
