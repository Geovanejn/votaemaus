...
/**
 * TABELA: bible_verses
 * ALTERAÇÃO: Adicionado .unique() no campo reference para permitir
 * scripts de carga automática (seed) sem duplicar versículos.
 */
export const bibleVerses = pgTable("bible_verses", {
  id: serial("id").primaryKey(),
  reference: text("reference").notNull().unique(), // Alterado aqui
...
// [Restante dos schemas omitido por brevidade, mantendo a estrutura principal]
